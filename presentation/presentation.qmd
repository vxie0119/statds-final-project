...
- Primarily using **InjuryRecord.feather** and **PlayList.feather**
- `InjuryRecord.feather`
...
- Supports previous studies that synthetic fields result in a higher chance of lower body extremity injuries.
